...
impl Splits {
    pub fn new() -> Splits {
        ...
        let battle_splits = [
            ...
            ("MF_JOY_Moissonneuse_MaskJoy*3", "visages_joy_mask"),
            ("MF_SADNESS_Chapelier_MaskSadness*3", "visages_sadness_mask"),
            ("MF_ANGRY_BoucheclierMaskAnger*3", "visages_angry_mask"),
